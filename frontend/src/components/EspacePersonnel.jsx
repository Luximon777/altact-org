...
import { User, Shield, Heart, Compass, Scale, Brain, CheckCircle, Sparkles, MessageCircle, FileText, Users, AlertTriangle, Handshake, Eye, ChevronRight, Phone, ArrowRight, Lock, BookOpen, HeartHandshake, Briefcase, ShieldCheck, UserCheck, Network } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <section className="relative pt-32 pb-20 overflow-hidden">
        <div className="absolute inset-0">
          <img src="https://images.unsplash.com/photo-1573497019940-1c28c88b4f3e?w=1920&q=80" alt="Accompagnement professionnel" className="w-full h-full object-cover" />
