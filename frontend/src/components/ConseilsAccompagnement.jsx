    ...
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white">
      <header className="relative bg-gradient-to-br from-[#0b2a55] via-[#1a4280] to-[#0b2a55] text-white py-20 overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <h1 className="text-4xl md:text-5xl font-bold mb-6">Conseils & Accompagnement</h1>
          <p className="text-xl text-blue-100 max-w-3xl leading-relaxed">
            Des solutions sur mesure pour le <strong className="text-white">bien-être au travail</strong>, au service des salariés comme des dirigeants.
          </p>
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-gray-700 leading-relaxed mb-4">
                Chez ALT&ACT, nous croyons que le <strong>bien-être au travail</strong> n'est pas un luxe, mais une condition essentielle de la performance durable.
              </p>
              <p className="text-gray-700 leading-relaxed">
                Notre approche conjugue expertise technique et sensibilité humaine.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 pb-16">
        <div className="text-center mb-12">
          ...
          <p className="text-gray-600 max-w-2xl mx-auto">Quatre axes stratégiques pour accompagner votre organisation</p>
        </div>
                ...
                <CardContent className="p-0">
                  <div className="grid md:grid-cols-3">
                    ...
                    <div className="md:col-span-2 p-8">
                      ...
                      <div className="mb-6">
                        <h4 className="text-sm font-semibold text-gray-500 uppercase tracking-wider mb-4">Interventions possibles</h4>
      ...
      <section className="bg-gradient-to-r from-[#0b2a55] to-[#1a4280] py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-blue-100 mb-8 max-w-2xl mx-auto">Contactez-nous pour échanger sur vos besoins.</p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button onClick={handleBackHome} className="bg-orange-500 hover:bg-orange-600 text-white px-8 py-6 text-lg">
              <MessageCircle className="w-5 h-5 mr-2" />
              Nous contacter
            </Button>
            <Button variant="outline" onClick={() => navigate('/charte-ethique')} className="border-white text-white hover:bg-white hover:text-[#0b2a55] px-8 py-6 text-lg">
      ...
      <section className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid md:grid-cols-4 gap-6">
          {[
            { icon: Heart, title: "Humanisme", desc: "L'humain au centre" },
            { icon: Target, title: "Sur mesure", desc: "Solutions adaptées" },
            { icon: Shield, title: "Éthique", desc: "Pratiques irréprochables" },
            { icon: TrendingUp, title: "Impact", desc: "Résultats durables" }
          ].map((value, idx) => {
