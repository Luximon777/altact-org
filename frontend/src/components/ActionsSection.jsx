...
import { Users, ArrowRight, Compass, Heart, Building, Globe, Sparkles } from 'lucide-react';
...
const ActionsSection = () => {
  const actionsData = [
    ...
    {
      public: \"Territoires & Partenaires\",
      ...
      <div className=\"max-w-7xl mx-auto px-4 sm:px-6 lg:px-8\">
        ...
        <div className=\"text-center mb-16\">
          ...
          <p className=\"text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed\">
            Nous ne cherchons pas à insérer des personnes dans un système existant — nous les accompagnons à devenir suffisamment solides pour y contribuer et, parfois, pour le transformer.
          </p>
        </div>
        ...
        <div className=\"mt-16 text-center\">
          <div className=\"inline-block p-8 bg-gradient-to-br from-amber-50 to-orange-50 rounded-2xl border border-orange-100 max-w-3xl\">
            <p className=\"text-xl text-gray-800 italic leading-relaxed mb-4\">
              &quot;Accompagner ne consiste pas à intégrer une personne dans un système, mais à l&apos;aider à devenir suffisamment structurée pour contribuer à transformer ce système.&quot;
            </p>
