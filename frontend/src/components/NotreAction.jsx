...
📄 NotreAmbition.jsx (imports nettoyés)
import React, { useState, useEffect } from 'react';
...
📄 NotreAction.jsx (imports nettoyés)
import React, { useState, useEffect } from 'react';
  ...
  const actionsData = [
    {
      ...
      description: "Nous agissons pour accompagner les trajectoires professionnelles dans un contexte marque par les transitions et les incertitudes, en aidant chacun a developper ses ressources, a renforcer sa capacite d adaptation et a donner une direction a son parcours.",
      color: "amber"
    },
    {
      icon: Target,
      title: "Developper les competences",
      description: "Nous soutenons le developpement des competences comme un processus continu, indissociable de la croissance personnelle et relationnelle.",
      color: "blue"
    },
    {
      icon: Heart,
      title: "S adapter a la diversite",
      description: "Parce que les realites sont multiples, nous adaptons nos approches a la diversite des parcours, dans une attention constante aux singularites culturelles, sociales et aux situations de handicap, en veillant a reconnaitre les talents avant de considerer les limites.",
      color: "rose"
    },
    {
      icon: Building,
      title: "Transformer les organisations",
      description: "Nous accompagnons egalement les organisations desireuses de faire evoluer leurs pratiques vers des environnements plus responsables, inclusifs et respectueux des personnes, convaincus que la qualite des relations de travail constitue l un des leviers majeurs d une performance durable.",
      color: "teal"
    },
    {
      icon: Scale,
      title: "Favoriser l equite",
      description: "Enfin, nous agissons en faveur de l equite en prevenant les discriminations et en favorisant une participation pleine et entiere a la vie professionnelle et sociale.",
      color: "purple"
    }
  ];
      ...
      <section className="relative pt-32 pb-20 bg-gradient-to-br from-green-900 via-teal-800 to-[#0b2a55] overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-xl md:text-2xl text-green-100 max-w-4xl mx-auto leading-relaxed">
            En placant l ethique, la responsabilite et la contribution au coeur des pratiques.
          </p>
        </div>
      </section>
          ...
          <div className="flex flex-col lg:flex-row gap-8">
                ...
                <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
                  ...
                  <div className="px-5 pb-5">
                    <div className="bg-gradient-to-br from-green-50 to-teal-50 rounded-xl p-4 border border-green-100">
                      <p className="text-sm text-gray-700 italic leading-relaxed">
                        Accompagner les transformations en placant l ethique au coeur des pratiques.
                      </p>
            ...
            <main className="flex-1 min-w-0 space-y-12">
              ...
              <div id="engagement" className="bg-gradient-to-r from-green-50 to-teal-50 rounded-3xl p-8 md:p-12 border-l-4 border-green-500">
                ...
                <p className="text-lg text-gray-700 leading-relaxed">
                  Notre action s inscrit dans cette ambition : <strong className="text-green-700">accompagner les transformations humaines et professionnelles</strong> en placant l ethique, la responsabilite et la contribution au coeur des pratiques.
                </p>
              </div>
              ...
              <div id="citation" className="bg-gradient-to-r from-green-600 to-teal-600 rounded-3xl p-8 md:p-12 text-center text-white">
                <Sparkles className="w-12 h-12 mx-auto mb-6 text-amber-300" />
                <blockquote className="text-xl md:text-2xl font-medium leading-relaxed mb-6">
                  Car une societe progresse lorsque chacun peut non seulement acceder aux opportunites, mais aussi prendre part a ce qu elles rendent possible.
                </blockquote>
              </div>
              ...
              <div id="service" className="grid md:grid-cols-2 gap-8 items-center">
                <div className="bg-gradient-to-br from-[#0b2a55] to-[#1a4280] rounded-3xl p-8 text-white">
                  ...
                  <p className="text-blue-100 leading-relaxed mb-4">
                    Notre action est guidee par une conviction profonde : le travail est un <strong className="text-white">acte de service a la communaute</strong>.
                  </p>
                  <p className="text-blue-100 leading-relaxed">
                    Chaque intervention, chaque accompagnement vise a permettre aux personnes de contribuer pleinement a la societe, en reconnaissant leur dignite et leur potentiel.
                  </p>
                </div>
                <div>
                  <div className="space-y-4">
              ...
              <div id="europe" className="bg-blue-50 rounded-3xl p-8 md:p-12 border border-blue-200">
                ...
                <p className="text-gray-700 text-lg leading-relaxed mb-6">
                  Notre action s inscrit dans le cadre des directives et visions europeennes en matiere d emploi, d inclusion et de developpement durable :
                </p>
