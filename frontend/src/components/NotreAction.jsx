...
const NotreAction = () => {
  ...
  const actionsData = [
    { icon: Compass, title: "Accompagner les trajectoires professionnelles", description: "Nous agissons pour accompagner les trajectoires professionnelles dans un contexte marque par les transitions et les incertitudes, en aidant chacun a developper ses ressources, a renforcer sa capacite d'adaptation et a donner une direction a son parcours.", color: "amber" },
    { icon: Target, title: "Developper les competences", description: "Nous soutenons le developpement des competences comme un processus continu, indissociable de la croissance personnelle et relationnelle.", color: "blue" },
    { icon: Heart, title: "S'adapter a la diversite", description: "Parce que les realites sont multiples, nous adaptons nos approches a la diversite des parcours, dans une attention constante aux singularites culturelles, sociales et aux situations de handicap, en veillant a reconnaitre les talents avant de considerer les limites.", color: "rose" },
    { icon: Building, title: "Transformer les organisations", description: "Nous accompagnons egalement les organisations desireuses de faire evoluer leurs pratiques vers des environnements plus responsables, inclusifs et respectueux des personnes, convaincus que la qualite des relations de travail constitue l'un des leviers majeurs d'une performance durable.", color: "teal" },
    { icon: Scale, title: "Favoriser l'equite", description: "Enfin, nous agissons en faveur de l'equite en prevenant les discriminations et en favorisant une participation pleine et entiere a la vie professionnelle et sociale.", color: "purple" }
  ];
            ...
            <main className="flex-1 min-w-0 space-y-12">
              ...
              <div id="service" className="grid md:grid-cols-2 gap-8 items-center">
                <div className="bg-gradient-to-br from-[#0b2a55] to-[#1a4280] rounded-3xl p-8 text-white">
                  ...
                  <p className="text-blue-100 leading-relaxed">Chaque intervention, chaque accompagnement vise a permettre aux personnes de contribuer pleinement a la societe, en reconnaissant leur dignite et leur potentiel.</p>
                </div>
                <div>
              ...
              <div className="text-center pt-8">
                <div className="inline-flex flex-col sm:flex-row gap-4">
                  ...
                  <Button onClick={() => navigate('/notre-mission')} variant="outline" className="border-gray-300 text-gray-700 hover:bg-gray-100 px-8 py-6 text-lg rounded-full">Revenir a notre mission</Button>
                </div>
              </div>
            </main>
          </div>
