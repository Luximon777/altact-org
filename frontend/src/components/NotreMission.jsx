    ...
    <div className="min-h-screen bg-gray-50" data-testid="notre-mission-page">
      ...
      <section className="relative pt-32 pb-20 bg-gradient-to-br from-[#0b2a55] via-[#1a4280] to-[#0b2a55] overflow-hidden">
        ...
        <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h1 className="text-4xl md:text-5xl lg:text-6xl font-bold text-white mb-8 leading-tight">Reveler les capacites humaines</h1>
          <p className="text-xl md:text-2xl text-blue-100 max-w-4xl mx-auto leading-relaxed">Structurer le pouvoir d'agir et permettre a chacun de contribuer pleinement a la societe.</p>
        </div>
      </section>
          ...
          <div className="flex flex-col lg:flex-row gap-8">
                ...
                <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
                  ...
                  <div className="px-5 pb-5">
                    <div className="bg-gradient-to-br from-amber-50 to-orange-50 rounded-xl p-4 border border-amber-100">
                      <p className="text-sm text-gray-700 italic leading-relaxed">"Reveler les capacites humaines, c'est permettre a chacun de contribuer pleinement a la societe."</p>
            ...
            <main className="flex-1 min-w-0 space-y-12">
              <div id="conviction" className="bg-gradient-to-r from-amber-50 to-orange-50 rounded-3xl p-8 md:p-12 border-l-4 border-amber-500">
                ...
                <p className="text-lg text-gray-700 leading-relaxed mb-6">Nous partons d'une conviction essentielle : <strong className="text-amber-700">chaque personne porte en elle un potentiel de developpement</strong> qui, lorsqu'il est reconnu et cultive, devient une force pour l'ensemble de la collectivite.</p>
                <p className="text-lg text-gray-700 leading-relaxed">Notre mission consiste a creer les conditions dans lesquelles ces capacites peuvent <strong className="text-amber-700">emerger, se renforcer et s'inscrire dans des trajectoires professionnelles porteuses de sens</strong>.</p>
              </div>
              <div id="travail" className="grid md:grid-cols-2 gap-8 items-center">
                <div>
                  <h3 className="text-2xl font-bold text-gray-900 mb-6">Le travail, bien plus qu'une fonction economique</h3>
                  <p className="text-gray-700 leading-relaxed mb-4">Nous considerons le travail non comme une simple fonction economique, mais comme un <strong>espace d'expression, d'apprentissage continu et de responsabilite</strong>.</p>
                  <p className="text-gray-700 leading-relaxed">En favorisant l'autonomie, la maturite et la capacite de cooperation, nous contribuons a former des femmes et des hommes capables de s'orienter dans un monde en transformation et de participer activement au bien commun.</p>
                </div>
              ...
              <div id="service" className="bg-gradient-to-r from-[#0b2a55] to-[#1a4280] rounded-3xl p-8 md:p-12 text-white">
                ...
                <p className="text-blue-100 text-lg leading-relaxed mb-6">Nous concevons le rapport au travail comme un <strong className="text-white">acte de service a la communaute</strong>. Chaque contribution professionnelle, quelle que soit sa nature, participe a l'edification d'une societe plus solidaire et plus humaine.</p>
                <p className="text-blue-100 text-lg leading-relaxed">Cette vision transforme le travail en un vecteur de dignite, de reconnaissance mutuelle et de progres partage.</p>
              </div>
              <div id="europe" className="bg-blue-50 rounded-3xl p-8 md:p-12 border border-blue-200">
                ...
                <p className="text-gray-700 text-lg leading-relaxed mb-4">Notre action s'inscrit dans le cadre des orientations et visions europeennes en matiere d'emploi, d'inclusion sociale et de developpement durable.</p>
                <p className="text-gray-700 leading-relaxed">Nous portons une attention particuliere aux recommandations du <strong>Socle europeen des droits sociaux</strong>, a la <strong>Strategie europeenne pour l'emploi</strong> et aux objectifs de developpement durable (ODD), notamment ceux lies au travail decent et a la reduction des inegalites.</p>
              </div>
              <div id="piliers">
                ...
                <div className="grid md:grid-cols-3 gap-6">
                  <div className="bg-white rounded-2xl p-6 shadow-lg border-t-4 border-amber-500 hover:shadow-xl transition-shadow">
                    ...
                    <p className="text-gray-600">Mettre en lumiere les potentiels caches et les capacites inexploitees de chaque personne.</p>
                  </div>
                  <div className="bg-white rounded-2xl p-6 shadow-lg border-t-4 border-blue-500 hover:shadow-xl transition-shadow">
                    ...
                    <p className="text-gray-600">Accompagner le developpement du pouvoir d'agir et de l'autonomie decisionnelle.</p>
                  </div>
                  <div className="bg-white rounded-2xl p-6 shadow-lg border-t-4 border-green-500 hover:shadow-xl transition-shadow">
                    ...
                    <p className="text-gray-600">Permettre a chacun de participer pleinement a la vie economique et sociale.</p>
                  </div>
                </div>
              </div>
              <div className="text-center pt-8">
                <div className="inline-flex flex-col sm:flex-row gap-4">
                  <Button onClick={() => navigate('/notre-ambition')} className="bg-amber-500 hover:bg-amber-600 text-white px-8 py-6 text-lg rounded-full">Decouvrir notre ambition<ArrowRight className="w-5 h-5 ml-2" /></Button>
